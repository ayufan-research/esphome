...
void Display::vprintf_(int x, int y, BaseFont *font, Color color, TextAlign align, const char *format,
                             va_list arg) {
  char buffer[256];
...
void Display::legend(int x, int y, graph::Graph *graph, Color color_on) {
...
void Display::strftime(int x, int y, BaseFont *font, Color color, TextAlign align, const char *format,
                             ESPTime time) {
  char buffer[64];
...
bool Display::clamp_x(int x, int w, int &min_x, int &max_x) {
  min_x = std::max(x, 0);
...
bool Display::clamp_y(int y, int h, int &min_y, int &max_y) {
  min_y = std::max(y, 0);
